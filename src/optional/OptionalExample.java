...
public class OptionalExample {
    public static void main(String[] args) {
        ...
        Optional<List<Employee>> employees = optionalExample.getEmployees();
        if(employees.isPresent()) {
            List<Employee> employeesList = employees.get();
            System.out.println("Employees data exist");
        } else {
            System.out.println("No Employees data");
        }
    }
